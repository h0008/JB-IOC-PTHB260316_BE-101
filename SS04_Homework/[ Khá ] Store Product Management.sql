...
-- 1 - Add a new product record with the name "Điều hòa Panasonic", category "Home Appliances", price 400.00, and stock 10
...
-- 8 - List the first 2 products in descending order of price, or get from the 2nd to the 3rd product (use LIMIT and OFFSET)
SELECT name, category, price, stock FROM products_basic
ORDER BY price DESC
LIMIT 2 OFFSET 1;
